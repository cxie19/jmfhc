...
est_surv_func <- function(object,z_value,x_value,event_time,n.random=1000){
  ...
  gammas <- coef[length(2+length(z_value)+length_re):length(2+length(z_value)+length_re+length(x_value))]
